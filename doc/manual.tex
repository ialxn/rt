...
{\tt flux\_2D} outputs the flux distribution (2D histogram) of planar targets. Statistical data including the number of rays missed and the total power contained in those is reported in the header.
