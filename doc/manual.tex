...
{\tt flux\_3D} outputs the distribution of the absorbed flux for non-planar targets (at present: {\tt cone}, {\tt cylinder}, and {\tt sphere}).
...
\item[{\tt [--type|-t]}] Type of body ['cone'$\mid$'cylinder'$\mid$'sphere'].
